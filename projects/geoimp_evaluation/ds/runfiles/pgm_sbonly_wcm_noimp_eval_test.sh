...
#SBATCH -t 48:00:00
#SBATCH -J pgm_sbonly_wcm_noimp_eval_test
#SBATCH -o /proj/snic2017-1-306/projects/geoimp_evaluation/current/ds/logs/pgm_sbonly_wcm_noimp_eval_test.log
...
python main.py  --dir_scratch  $SNIC_TMP/ds \
                ...
                --dir_input /proj/snic2017-1-306/projects/noimp_evaluation/current/ds/input_noimp \
...
rsync -av --include "*/" --include "*.tex" --include "*.txt" --include "*.png" \
          ...
          --prune-empty-dirs \
           $SNIC_TMP/ds/pgm_sbonly_wcm_noimp_eval_test \
