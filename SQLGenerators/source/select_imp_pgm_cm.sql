SELECT
  ...
  pgm.month_id,
  pgm.country_id,
  geoimp.$ged_sb_dummy_n AS ged_dummy_sb,
  geoimp.$ged_ns_dummy_n AS ged_dummy_ns,
  geoimp.$ged_os_dummy_n AS ged_dummy_os,
...
FROM
  launched.$table_pgm as pgm
LEFT JOIN
  launched.$table_cm as cm
  ON
