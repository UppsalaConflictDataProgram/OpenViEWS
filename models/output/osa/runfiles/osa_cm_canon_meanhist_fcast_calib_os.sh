...
#SBATCH -t 8:00:00
#SBATCH -J osa_cm_canon_meanhist_fcast_calib_os
#SBATCH -o /proj/snic2018-3-380/runs/current/osa/logs/osa_cm_canon_meanhist_fcast_calib_os.log
...
python -u osa_cm_canon_meanhist_fcast_calib_os.py
