...
#SBATCH -t 8:00:00
#SBATCH -J osa_pgm_acled_meanhist_eval_test_os
#SBATCH -o /proj/snic2018-3-380/runs/current/osa/logs/osa_pgm_acled_meanhist_eval_test_os.log
...
python -u osa_pgm_acled_meanhist_eval_test_os.py
