...
#SBATCH -t 8:00:00
#SBATCH -J osa_cm_canon_inst_eval_test_sb
#SBATCH -o /proj/snic2018-3-380/runs/current/osa/logs/osa_cm_canon_inst_eval_test_sb.log
...
python -u osa_cm_canon_inst_eval_test_sb.py
