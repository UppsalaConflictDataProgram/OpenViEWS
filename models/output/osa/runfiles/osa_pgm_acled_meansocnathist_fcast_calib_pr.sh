...
#SBATCH -t 8:00:00
#SBATCH -J osa_pgm_acled_meansocnathist_fcast_calib_pr
#SBATCH -o /proj/snic2018-3-380/runs/current/osa/logs/osa_pgm_acled_meansocnathist_fcast_calib_pr.log
...
python -u osa_pgm_acled_meansocnathist_fcast_calib_pr.py
