...
#SBATCH -t 8:00:00
#SBATCH -J osa_cm_canon_meandemog_eval_calib_ns
#SBATCH -o /proj/snic2018-3-380/runs/current/osa/logs/osa_cm_canon_meandemog_eval_calib_ns.log
...
python -u osa_cm_canon_meandemog_eval_calib_ns.py
