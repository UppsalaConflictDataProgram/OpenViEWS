...
output_table    = "osa_pgm_acled_cm_fcast_test_os"

models = [
  {
    "dir_pickles": "$SNIC_TMP/osa/pickles/osa_pgm_acled_cm_fcast_test_os/pgm_acled_cm_fcast_test_logit_fullsample_os",
    "estimator": SMLogit(),
    "features": [
    ...
    "forecast_end": 502,
    "forecast_start": 465,
    "name": "pgm_acled_cm_fcast_test_logit_fullsample_os",
  ...
  {
    "dir_pickles": "$SNIC_TMP/osa/pickles/osa_pgm_acled_cm_fcast_test_os/pgm_acled_cm_fcast_test_logit_downsampled_os",
    "estimator": SMLogit(),
    "features": [
      "fvp_lngdpcap_nonoilrent",
      "fvp_lngdpcap_oilrent",
    ...
    "forecast_end": 502,
    "forecast_start": 465,
    "name": "pgm_acled_cm_fcast_test_logit_downsampled_os",
    "outcome": "ged_dummy_os",
    "share_ones_keep": 1,
  ...
  {
    "dir_pickles": "$SNIC_TMP/osa/pickles/osa_pgm_acled_cm_fcast_test_os/pgm_acled_cm_fcast_test_rf_downsampled_os",
    ...
    "forecast_end": 502,
    "forecast_start": 465,
    "name": "pgm_acled_cm_fcast_test_rf_downsampled_os",
    "outcome": "ged_dummy_os",
    "share_ones_keep": 1,
    "share_zeros_keep": 0.1,
    "steps": [
