...
output_table    = "osa_pgm_acled_nat_eval_test_os"

models = [
  {
    "dir_pickles": "$SNIC_TMP/osa/pickles/osa_pgm_acled_nat_eval_test_os/pgm_acled_nat_eval_test_logit_fullsample_os",
    "estimator": SMLogit(),
    "features": [
      "ln_dist_diamsec",
      "ln_dist_petroleum",
    ...
    "forecast_end": 456,
    "forecast_start": 421,
    "name": "pgm_acled_nat_eval_test_logit_fullsample_os",
  ...
  {
    "dir_pickles": "$SNIC_TMP/osa/pickles/osa_pgm_acled_nat_eval_test_os/pgm_acled_nat_eval_test_logit_downsampled_os",
    "estimator": SMLogit(),
    "features": [
      "ln_dist_diamsec",
      "ln_dist_petroleum",
    ...
    "forecast_end": 456,
    "forecast_start": 421,
    "name": "pgm_acled_nat_eval_test_logit_downsampled_os",
    "outcome": "ged_dummy_os",
    "share_ones_keep": 1,
  ...
  {
    "dir_pickles": "$SNIC_TMP/osa/pickles/osa_pgm_acled_nat_eval_test_os/pgm_acled_nat_eval_test_rf_downsampled_os",
    ...
    "forecast_end": 456,
    "forecast_start": 421,
    "name": "pgm_acled_nat_eval_test_rf_downsampled_os",
    "outcome": "ged_dummy_os",
    "share_ones_keep": 1,
    "share_zeros_keep": 0.1,
    "steps": [
