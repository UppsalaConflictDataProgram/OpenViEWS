...
output_table    = "osa_pgm_acled_cm_eval_test_ns"

models = [
  {
    "dir_pickles": "$SNIC_TMP/osa/pickles/osa_pgm_acled_cm_eval_test_ns/pgm_acled_cm_eval_test_logit_fullsample_ns",
    "estimator": SMLogit(),
    "features": [
    ...
    "forecast_end": 456,
    "forecast_start": 421,
    "name": "pgm_acled_cm_eval_test_logit_fullsample_ns",
  ...
  {
    "dir_pickles": "$SNIC_TMP/osa/pickles/osa_pgm_acled_cm_eval_test_ns/pgm_acled_cm_eval_test_logit_downsampled_ns",
    "estimator": SMLogit(),
    "features": [
      "fvp_lngdpcap_nonoilrent",
      "fvp_lngdpcap_oilrent",
    ...
    "forecast_end": 456,
    "forecast_start": 421,
    "name": "pgm_acled_cm_eval_test_logit_downsampled_ns",
    "outcome": "ged_dummy_ns",
    "share_ones_keep": 1,
  ...
  {
    "dir_pickles": "$SNIC_TMP/osa/pickles/osa_pgm_acled_cm_eval_test_ns/pgm_acled_cm_eval_test_rf_downsampled_ns",
    ...
    "forecast_end": 456,
    "forecast_start": 421,
    "name": "pgm_acled_cm_eval_test_rf_downsampled_ns",
    "outcome": "ged_dummy_ns",
    "share_ones_keep": 1,
    "share_zeros_keep": 0.1,
    "steps": [
