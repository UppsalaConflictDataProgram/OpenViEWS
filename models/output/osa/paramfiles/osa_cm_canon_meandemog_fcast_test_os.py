...
output_table    = "osa_cm_canon_meandemog_fcast_test_os"

models = [
  {
    "dir_pickles": "$SNIC_TMP/osa/pickles/osa_cm_canon_meandemog_fcast_test_os/cm_canon_meandemog_fcast_test_logit_fullsample_os",
    "estimator": SMLogit(),
    "features": [
    ...
    "forecast_end": 502,
    "forecast_start": 465,
    "name": "cm_canon_meandemog_fcast_test_logit_fullsample_os",
  ...
  {
    "dir_pickles": "$SNIC_TMP/osa/pickles/osa_cm_canon_meandemog_fcast_test_os/cm_canon_meandemog_fcast_test_logit_downsampled_os",
    "estimator": SMLogit(),
    "features": [
      "ln_fvp_population200",
      "ssp2_edu_sec_15_24_prop",
    ...
    "forecast_end": 502,
    "forecast_start": 465,
    "name": "cm_canon_meandemog_fcast_test_logit_downsampled_os",
    "outcome": "ged_dummy_os",
    "share_ones_keep": 1,
  ...
  {
    "dir_pickles": "$SNIC_TMP/osa/pickles/osa_cm_canon_meandemog_fcast_test_os/cm_canon_meandemog_fcast_test_rf_downsampled_os",
    ...
    "forecast_end": 502,
    "forecast_start": 465,
    "name": "cm_canon_meandemog_fcast_test_rf_downsampled_os",
    "outcome": "ged_dummy_os",
    "share_ones_keep": 1,
    "share_zeros_keep": 0.1,
    "steps": [
