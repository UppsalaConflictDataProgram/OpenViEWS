...
output_table    = "osa_cm_canon_mndmgecohstnst_eval_test_sb"

models = [
  {
    "dir_pickles": "$SNIC_TMP/osa/pickles/osa_cm_canon_mndmgecohstnst_eval_test_sb/cm_canon_mndmgecohstnst_eval_test_logit_fullsample_sb",
    "estimator": SMLogit(),
    "features": [
      "l2_ged_dummy_sb",
      "l3_ged_dummy_sb",
    ...
    "forecast_end": 456,
    "forecast_start": 421,
    "name": "cm_canon_mndmgecohstnst_eval_test_logit_fullsample_sb",
  ...
  {
    "dir_pickles": "$SNIC_TMP/osa/pickles/osa_cm_canon_mndmgecohstnst_eval_test_sb/cm_canon_mndmgecohstnst_eval_test_logit_downsampled_sb",
    "estimator": SMLogit(),
    "features": [
      "l2_ged_dummy_sb",
      "l3_ged_dummy_sb",
    ...
    "forecast_end": 456,
    "forecast_start": 421,
    "name": "cm_canon_mndmgecohstnst_eval_test_logit_downsampled_sb",
    "outcome": "ged_dummy_sb",
    "share_ones_keep": 1,
  ...
  {
    "dir_pickles": "$SNIC_TMP/osa/pickles/osa_cm_canon_mndmgecohstnst_eval_test_sb/cm_canon_mndmgecohstnst_eval_test_rf_downsampled_sb",
    ...
    "forecast_end": 456,
    "forecast_start": 421,
    "name": "cm_canon_mndmgecohstnst_eval_test_rf_downsampled_sb",
    "outcome": "ged_dummy_sb",
    "share_ones_keep": 1,
    "share_zeros_keep": 0.1,
    "steps": [
