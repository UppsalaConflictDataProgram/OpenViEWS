...
output_table    = "osa_pgm_acled_meancmhist_fcast_test_ns"

models = [
  {
    "dir_pickles": "$SNIC_TMP/osa/pickles/osa_pgm_acled_meancmhist_fcast_test_ns/pgm_acled_meancmhist_fcast_test_logit_fullsample_ns",
    "estimator": SMLogit(),
    "features": [
      "l2_ged_dummy_ns",
      "l3_ged_dummy_ns",
    ...
    "forecast_end": 502,
    "forecast_start": 465,
    "name": "pgm_acled_meancmhist_fcast_test_logit_fullsample_ns",
  ...
  {
    "dir_pickles": "$SNIC_TMP/osa/pickles/osa_pgm_acled_meancmhist_fcast_test_ns/pgm_acled_meancmhist_fcast_test_logit_downsampled_ns",
    "estimator": SMLogit(),
    "features": [
      "l2_ged_dummy_ns",
      "l3_ged_dummy_ns",
    ...
    "forecast_end": 502,
    "forecast_start": 465,
    "name": "pgm_acled_meancmhist_fcast_test_logit_downsampled_ns",
    "outcome": "ged_dummy_ns",
    "share_ones_keep": 1,
  ...
  {
    "dir_pickles": "$SNIC_TMP/osa/pickles/osa_pgm_acled_meancmhist_fcast_test_ns/pgm_acled_meancmhist_fcast_test_rf_downsampled_ns",
    ...
    "forecast_end": 502,
    "forecast_start": 465,
    "name": "pgm_acled_meancmhist_fcast_test_rf_downsampled_ns",
    "outcome": "ged_dummy_ns",
    "share_ones_keep": 1,
    "share_zeros_keep": 0.1,
    "steps": [
