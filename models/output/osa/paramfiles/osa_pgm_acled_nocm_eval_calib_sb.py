...
output_table    = "osa_pgm_acled_nocm_eval_calib_sb"

models = [
  {
    "dir_pickles": "$SNIC_TMP/osa/pickles/osa_pgm_acled_nocm_eval_calib_sb/pgm_acled_nocm_eval_calib_logit_fullsample_sb",
    "estimator": SMLogit(),
    "features": [
      "l2_ged_dummy_sb",
      "l3_ged_dummy_sb",
    ...
    "forecast_end": 420,
    "forecast_start": 385,
    "name": "pgm_acled_nocm_eval_calib_logit_fullsample_sb",
  ...
  {
    "dir_pickles": "$SNIC_TMP/osa/pickles/osa_pgm_acled_nocm_eval_calib_sb/pgm_acled_nocm_eval_calib_logit_downsampled_sb",
    "estimator": SMLogit(),
    "features": [
      "l2_ged_dummy_sb",
      "l3_ged_dummy_sb",
    ...
    "forecast_end": 420,
    "forecast_start": 385,
    "name": "pgm_acled_nocm_eval_calib_logit_downsampled_sb",
    "outcome": "ged_dummy_sb",
    "share_ones_keep": 1,
  ...
  {
    "dir_pickles": "$SNIC_TMP/osa/pickles/osa_pgm_acled_nocm_eval_calib_sb/pgm_acled_nocm_eval_calib_rf_downsampled_sb",
    ...
    "forecast_end": 420,
    "forecast_start": 385,
    "name": "pgm_acled_nocm_eval_calib_rf_downsampled_sb",
    "outcome": "ged_dummy_sb",
    "share_ones_keep": 1,
    "share_zeros_keep": 0.1,
    "steps": [
