...
output_table    = "osa_pgm_acled_wcm_fcast_test_pr"

models = [
  {
    "dir_pickles": "$SNIC_TMP/osa/pickles/osa_pgm_acled_wcm_fcast_test_pr/pgm_acled_wcm_fcast_test_logit_fullsample_pr",
    "estimator": SMLogit(),
    "features": [
      "l2_acled_dummy_pr",
      "l3_acled_dummy_pr",
    ...
    "forecast_end": 502,
    "forecast_start": 465,
    "name": "pgm_acled_wcm_fcast_test_logit_fullsample_pr",
  ...
  {
    "dir_pickles": "$SNIC_TMP/osa/pickles/osa_pgm_acled_wcm_fcast_test_pr/pgm_acled_wcm_fcast_test_logit_downsampled_pr",
    "estimator": SMLogit(),
    "features": [
      "l2_acled_dummy_pr",
      "l3_acled_dummy_pr",
    ...
    "forecast_end": 502,
    "forecast_start": 465,
    "name": "pgm_acled_wcm_fcast_test_logit_downsampled_pr",
    "outcome": "acled_dummy_pr",
    "share_ones_keep": 1,
  ...
  {
    "dir_pickles": "$SNIC_TMP/osa/pickles/osa_pgm_acled_wcm_fcast_test_pr/pgm_acled_wcm_fcast_test_rf_downsampled_pr",
    ...
    "forecast_end": 502,
    "forecast_start": 465,
    "name": "pgm_acled_wcm_fcast_test_rf_downsampled_pr",
    "outcome": "acled_dummy_pr",
    "share_ones_keep": 1,
    "share_zeros_keep": 0.1,
    "steps": [
