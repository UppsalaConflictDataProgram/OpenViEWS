...
output_table    = "osa_pgm_acled_meansocnathist_fcast_calib_os"

models = [
  {
    "dir_pickles": "$SNIC_TMP/osa/pickles/osa_pgm_acled_meansocnathist_fcast_calib_os/pgm_acled_meansocnathist_fcast_calib_logit_fullsample_os",
    "estimator": SMLogit(),
    "features": [
      "l2_ged_dummy_os",
      "l3_ged_dummy_os",
    ...
    "forecast_end": 464,
    "forecast_start": 429,
    "name": "pgm_acled_meansocnathist_fcast_calib_logit_fullsample_os",
  ...
  {
    "dir_pickles": "$SNIC_TMP/osa/pickles/osa_pgm_acled_meansocnathist_fcast_calib_os/pgm_acled_meansocnathist_fcast_calib_logit_downsampled_os",
    "estimator": SMLogit(),
    "features": [
      "l2_ged_dummy_os",
      "l3_ged_dummy_os",
    ...
    "forecast_end": 464,
    "forecast_start": 429,
    "name": "pgm_acled_meansocnathist_fcast_calib_logit_downsampled_os",
    "outcome": "ged_dummy_os",
    "share_ones_keep": 1,
  ...
  {
    "dir_pickles": "$SNIC_TMP/osa/pickles/osa_pgm_acled_meansocnathist_fcast_calib_os/pgm_acled_meansocnathist_fcast_calib_rf_downsampled_os",
    ...
    "forecast_end": 464,
    "forecast_start": 429,
    "name": "pgm_acled_meansocnathist_fcast_calib_rf_downsampled_os",
    "outcome": "ged_dummy_os",
    "share_ones_keep": 1,
    "share_zeros_keep": 0.1,
    "steps": [
