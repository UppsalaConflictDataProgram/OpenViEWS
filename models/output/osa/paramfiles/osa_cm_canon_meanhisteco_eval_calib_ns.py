...
output_table    = "osa_cm_canon_meanhisteco_eval_calib_ns"

models = [
  {
    "dir_pickles": "$SNIC_TMP/osa/pickles/osa_cm_canon_meanhisteco_eval_calib_ns/cm_canon_meanhisteco_eval_calib_logit_fullsample_ns",
    "estimator": SMLogit(),
    "features": [
      "l2_ged_dummy_ns",
      "l3_ged_dummy_ns",
    ...
    "forecast_end": 420,
    "forecast_start": 385,
    "name": "cm_canon_meanhisteco_eval_calib_logit_fullsample_ns",
  ...
  {
    "dir_pickles": "$SNIC_TMP/osa/pickles/osa_cm_canon_meanhisteco_eval_calib_ns/cm_canon_meanhisteco_eval_calib_logit_downsampled_ns",
    "estimator": SMLogit(),
    "features": [
      "l2_ged_dummy_ns",
      "l3_ged_dummy_ns",
    ...
    "forecast_end": 420,
    "forecast_start": 385,
    "name": "cm_canon_meanhisteco_eval_calib_logit_downsampled_ns",
    "outcome": "ged_dummy_ns",
    "share_ones_keep": 1,
  ...
  {
    "dir_pickles": "$SNIC_TMP/osa/pickles/osa_cm_canon_meanhisteco_eval_calib_ns/cm_canon_meanhisteco_eval_calib_rf_downsampled_ns",
    ...
    "forecast_end": 420,
    "forecast_start": 385,
    "name": "cm_canon_meanhisteco_eval_calib_rf_downsampled_ns",
    "outcome": "ged_dummy_ns",
    "share_ones_keep": 1,
    "share_zeros_keep": 0.1,
    "steps": [
