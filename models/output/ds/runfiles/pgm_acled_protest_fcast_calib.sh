...
#SBATCH -t 48:00:00
#SBATCH -J pgm_acled_protest_fcast_calib
#SBATCH -o /proj/snic2018-3-380/runs/current/ds/logs/pgm_acled_protest_fcast_calib.log
...
python main.py  --dir_scratch  $SNIC_TMP/ds \
                --run_id pgm_acled_protest_fcast_calib \
...
rsync -av --include "*/" --include "*.tex" --include "*.txt" --include "*.png" \
          ...
          --prune-empty-dirs \
           $SNIC_TMP/ds/pgm_acled_protest_fcast_calib \
