...
#SBATCH -t 48:00:00
#SBATCH -J pgm_acled_meansocnat_fcast_test
#SBATCH -o /proj/snic2018-3-380/runs/current/ds/logs/pgm_acled_meansocnat_fcast_test.log
...
rsync -av --include "*/" --include "*.tex" --include "*.txt" --include "*.png" \
          ...
          --prune-empty-dirs \
           $SNIC_TMP/ds/pgm_acled_meansocnat_fcast_test \
