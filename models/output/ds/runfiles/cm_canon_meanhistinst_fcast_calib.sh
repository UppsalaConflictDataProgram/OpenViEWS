...
#SBATCH -t 48:00:00
#SBATCH -J cm_canon_meanhistinst_fcast_calib
#SBATCH -o /proj/snic2018-3-380/runs/current/ds/logs/cm_canon_meanhistinst_fcast_calib.log
...
rsync -av --include "*/" --include "*.tex" --include "*.txt" --include "*.png" \
          ...
          --prune-empty-dirs \
           $SNIC_TMP/ds/cm_canon_meanhistinst_fcast_calib \
