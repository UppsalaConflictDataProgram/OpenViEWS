...
#SBATCH -t 48:00:00
#SBATCH -J cm_canon_meandemog_fcast_test
#SBATCH -o /proj/snic2018-3-380/runs/current/ds/logs/cm_canon_meandemog_fcast_test.log
...
python main.py  --dir_scratch  $SNIC_TMP/ds \
                --run_id cm_canon_meandemog_fcast_test \
...
rsync -av --include "*/" --include "*.tex" --include "*.txt" --include "*.png" \
          ...
          --prune-empty-dirs \
           $SNIC_TMP/ds/cm_canon_meandemog_fcast_test \
