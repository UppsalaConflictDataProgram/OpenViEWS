...
#SBATCH -t 4:00:00
#SBATCH -J pgm_transforms
#SBATCH -o /proj/snic2018-3-380/runs/current/ds/logs/pgm_transforms.log
...
rsync -av --include "*/" --include "*.tex" --include "*.txt" --include "*.png" \
          ...
          --prune-empty-dirs \
           $SNIC_TMP/ds/pgm_transforms \
          /proj/snic2018-3-380/runs/current/ds/results \


mkdir -p /proj/snic2018-3-380/runs/current/ds/transforms/pgm_transforms
rsync -av $SNIC_TMP/ds/pgm_transforms/data /proj/snic2018-3-380/runs/current/ds/transforms/pgm_transforms
echo 'finished'