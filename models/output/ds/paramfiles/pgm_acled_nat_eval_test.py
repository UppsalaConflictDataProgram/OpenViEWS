...
models = [
  {
    "formula": "ged_dummy_ns ~ ln_dist_diamsec + ln_dist_petroleum + agri_ih_li + barren_ih_li + forest_ih_li + mountains_mean + savanna_ih_li + shrub_ih_li + pasture_ih_li + urban_ih_li",
    "modtype": "SMLogit",
    "name": "pgm_acled_nat_eval_test_ns"
  },
  {
    "formula": "ged_dummy_os ~ ln_dist_diamsec + ln_dist_petroleum + agri_ih_li + barren_ih_li + forest_ih_li + mountains_mean + savanna_ih_li + shrub_ih_li + pasture_ih_li + urban_ih_li",
    "modtype": "SMLogit",
    "name": "pgm_acled_nat_eval_test_os"
  },
  {
    ...
    "modtype": "SMLogit",
    "name": "pgm_acled_nat_eval_test_pr"
  },
  {
    "formula": "ged_dummy_sb ~ ln_dist_diamsec + ln_dist_petroleum + agri_ih_li + barren_ih_li + forest_ih_li + mountains_mean + savanna_ih_li + shrub_ih_li + pasture_ih_li + urban_ih_li",
    "modtype": "SMLogit",
    "name": "pgm_acled_nat_eval_test_sb"
  }
]
