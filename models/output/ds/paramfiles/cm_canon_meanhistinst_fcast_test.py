...
run_id = "cm_canon_meanhistinst_fcast_test"
timevar = "month_id"
groupvar = "country_id"
...
models = [
  {
    "formula": "ged_dummy_ns ~ l2_ged_dummy_ns + l3_ged_dummy_ns + l4_ged_dummy_ns + l5_ged_dummy_ns + l6_ged_dummy_ns + l7_ged_dummy_ns + l8_ged_dummy_ns + l9_ged_dummy_ns + l10_ged_dummy_ns + l11_ged_dummy_ns + l12_ged_dummy_ns + mean_ged_dummy_ns + ln_fvp_timeindep + ln_fvp_timesincepreindepwar + ln_fvp_timesinceregimechange + fvp_demo + fvp_semi + fvp_prop_excluded",
    "modtype": "SMLogit",
    "name": "cm_canon_meanhistinst_fcast_test_ns"
  },
  {
    ...
    "modtype": "SMLogit",
    "name": "cm_canon_meanhistinst_fcast_test_os"
  },
  {
    ...
    "modtype": "SMLogit",
    "name": "cm_canon_meanhistinst_fcast_test_sb"
  }
]
