...
models = [
  {
    "formula": "ged_dummy_ns ~ fvp_lngdpcap_nonoilrent + fvp_lngdpcap_oilrent + fvp_grgdpcap_oilrent + fvp_grgdpcap_nonoilrent",
    "modtype": "SMLogit",
    "name": "cm_canon_eco_eval_calib_ns"
  },
  {
    "formula": "ged_dummy_os ~ fvp_lngdpcap_nonoilrent + fvp_lngdpcap_oilrent + fvp_grgdpcap_oilrent + fvp_grgdpcap_nonoilrent",
    "modtype": "SMLogit",
    "name": "cm_canon_eco_eval_calib_os"
  },
  {
    "formula": "ged_dummy_sb ~ fvp_lngdpcap_nonoilrent + fvp_lngdpcap_oilrent + fvp_grgdpcap_oilrent + fvp_grgdpcap_nonoilrent",
    "modtype": "SMLogit",
    "name": "cm_canon_eco_eval_calib_sb"
  }
]
