...
run_id = "cm_canon_meanhist_fcast_test"
timevar = "month_id"
groupvar = "country_id"
...
models = [
  {
    "formula": "ged_dummy_ns ~ l2_ged_dummy_ns + l3_ged_dummy_ns + l4_ged_dummy_ns + l5_ged_dummy_ns + l6_ged_dummy_ns + l7_ged_dummy_ns + l8_ged_dummy_ns + l9_ged_dummy_ns + l10_ged_dummy_ns + l11_ged_dummy_ns + l12_ged_dummy_ns + mean_ged_dummy_ns + l1_ged_dummy_sb + l1_ged_dummy_ns + l1_ged_dummy_os + decay_12_cw_ged_dummy_sb_0 + decay_12_cw_ged_dummy_ns_0 + decay_12_cw_ged_dummy_os_0",
    "modtype": "SMLogit",
    "name": "cm_canon_meanhist_fcast_test_ns"
  },
  {
    ...
    "modtype": "SMLogit",
    "name": "cm_canon_meanhist_fcast_test_os"
  },
  {
    ...
    "modtype": "SMLogit",
    "name": "cm_canon_meanhist_fcast_test_sb"
  }
]
