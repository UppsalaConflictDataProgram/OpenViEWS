...
models = [
  {
    ...
    "modtype": "SMLogit",
    "name": "pgm_acled_meansocnat_eval_calib_ns"
  },
  {
    "formula": "ged_dummy_os ~ mean_ged_dummy_os + ln_bdist3 + ln_ttime + ln_capdist + ln_pop + gcp_li_mer + imr_mean + excluded_dummy_li + ln_dist_diamsec + ln_dist_petroleum + agri_ih_li + barren_ih_li + forest_ih_li + mountains_mean + savanna_ih_li + shrub_ih_li + pasture_ih_li + urban_ih_li",
    "modtype": "SMLogit",
    "name": "pgm_acled_meansocnat_eval_calib_os"
  },
  {
    "formula": "acled_dummy_pr ~ mean_acled_dummy_pr + ln_bdist3 + ln_ttime + ln_capdist + ln_pop + gcp_li_mer + imr_mean + excluded_dummy_li + ln_dist_diamsec + ln_dist_petroleum + agri_ih_li + barren_ih_li + forest_ih_li + mountains_mean + savanna_ih_li + shrub_ih_li + pasture_ih_li + urban_ih_li",
    "modtype": "SMLogit",
    "name": "pgm_acled_meansocnat_eval_calib_pr"
  },
  {
    "formula": "ged_dummy_sb ~ mean_ged_dummy_sb + ln_bdist3 + ln_ttime + ln_capdist + ln_pop + gcp_li_mer + imr_mean + excluded_dummy_li + ln_dist_diamsec + ln_dist_petroleum + agri_ih_li + barren_ih_li + forest_ih_li + mountains_mean + savanna_ih_li + shrub_ih_li + pasture_ih_li + urban_ih_li",
    "modtype": "SMLogit",
    "name": "pgm_acled_meansocnat_eval_calib_sb"
  }
]
