...
SELECT
  ...
  pgm.month_id,
  pgm.country_id,
  geoimp.ged_sb_dummy_5 AS ged_dummy_sb,
  geoimp.ged_ns_dummy_5 AS ged_dummy_ns,
  geoimp.ged_os_dummy_5 AS ged_dummy_os,
...
FROM
  launched.pgmimp5bnd as pgm
LEFT JOIN
  launched.cm_imp_5 as cm
  ON
