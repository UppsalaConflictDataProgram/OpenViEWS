...
SELECT
  ...
  pgm.month_id,
  pgm.country_id,
  geoimp.ged_sb_dummy_2 AS ged_dummy_sb,
  geoimp.ged_ns_dummy_2 AS ged_dummy_ns,
  geoimp.ged_os_dummy_2 AS ged_dummy_os,
...
FROM
  launched.pgmimp2bnd as pgm
LEFT JOIN
  launched.cm_imp_2 as cm
  ON
