...
last_known_month = 456

train_start_canon = 121
train_start_acled = 205

train_end_train  = last_known_month - 72
train_end_calib  = last_known_month - 36
train_end_test   = last_known_month

predict_start_train  = last_known_month - 71
predict_start_calib  = last_known_month - 35
predict_start_test   = last_known_month + 1

predict_end_train = predict_start_train + 35
predict_end_calib = predict_start_calib + 35
predict_end_test  = predict_start_test + 35
...
logit_canon_full_calib_sb = {
    ...
    'forecast_start' :  predict_start_calib,
    'forecast_end' :  predict_end_calib,
    'table' : table_input}
...
logit_canon_full_test_sb = {
    ...
    'forecast_start' :  predict_start_test,
    'forecast_end' :  predict_end_test,
    'table' : table_input}


logit_acled_full_train_sb = {
    'name' : 'logit_acled_full_train_sb',
    'estimator' : SMLogit(),
    'outcome' : 'ged_dummy_sb',
...
logit_canon_ones_train_sb = {
    'name' : 'logit_canon_ones_train_sb',
    'estimator' : SMLogit(),
    'outcome' : 'ged_dummy_sb',
    'features' : features_canon_sb,
    'steps' : steps,
...
logit_acled_ones_train_sb = {
    'name' : 'logit_acled_ones_train_sb',
    'estimator' : SMLogit(),
    'outcome' : 'ged_dummy_sb',
    'features' : features_acled_sb,
    'steps' : steps,
...
logit_canon_full_train_ns = {
    'name' : 'logit_canon_full_train_ns',
    'estimator' : SMLogit(),
...
logit_acled_full_train_ns = {
    'name' : 'logit_acled_full_train_ns',
    'estimator' : SMLogit(),
    'outcome' : 'ged_dummy_ns',
...
logit_canon_ones_train_ns = {
    'name' : 'logit_canon_ones_train_ns',
    'estimator' : SMLogit(),
    'outcome' : 'ged_dummy_ns',
    'features' : features_canon_ns,
    'steps' : steps,
...
logit_acled_ones_train_ns = {
    'name' : 'logit_acled_ones_train_ns',
    'estimator' : SMLogit(),
    'outcome' : 'ged_dummy_ns',
    'features' : features_acled_ns,
    'steps' : steps,
...
logit_canon_full_train_os = {
    'name' : 'logit_canon_full_train_os',
    'estimator' : SMLogit(),
...
logit_acled_full_train_os = {
    'name' : 'logit_acled_full_train_os',
    'estimator' : SMLogit(),
    'outcome' : 'ged_dummy_os',
...
logit_canon_ones_train_os = {
    'name' : 'logit_canon_ones_train_os',
    'estimator' : SMLogit(),
    'outcome' : 'ged_dummy_os',
    'features' : features_canon_os,
    'steps' : steps,
...
logit_acled_ones_train_os = {
    'name' : 'logit_acled_ones_train_os',
    'estimator' : SMLogit(),
    'outcome' : 'ged_dummy_os',
    'features' : features_acled_os,
    'steps' : steps,
