...
#SBATCH -t 48:00:00
#SBATCH -J pgm_canon_cmvars_fcast_calib
#SBATCH -o /proj/snic2017-1-306/runs/current/ds/logs/pgm_canon_cmvars_fcast_calib.log
...
rsync -av --include "*/" --include "*.tex" --include "*.txt" --include "*.png" \
          ...
          --prune-empty-dirs \
          /scratch/ds/pgm_canon_cmvars_fcast_calib \
