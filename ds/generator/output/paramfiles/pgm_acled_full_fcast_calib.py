...
run_id = "pgm_acled_full_fcast_calib"
timevar = "month_id"
groupvar = "pg_id"
...
ts = [
            ...
            {"name" : "cw_acled_dummy_pr_0", "var" : "acled_dummy_pr", "cw": "==0"},

            {"name" : "l1_acled_dummy_pr",      "var" : "acled_dummy_pr", "lag" : 1},
            {"name" : "l2_acled_dummy_pr",      "var" : "acled_dummy_pr", "lag" : 2},
            {"name" : "l3_acled_dummy_pr",      "var" : "acled_dummy_pr", "lag" : 3},
            {"name" : "l4_acled_dummy_pr",      "var" : "acled_dummy_pr", "lag" : 4},
            {"name" : "l5_acled_dummy_pr",      "var" : "acled_dummy_pr", "lag" : 5},
            {"name" : "l6_acled_dummy_pr",      "var" : "acled_dummy_pr", "lag" : 6},
            {"name" : "l7_acled_dummy_pr",      "var" : "acled_dummy_pr", "lag" : 7},
            {"name" : "l8_acled_dummy_pr",      "var" : "acled_dummy_pr", "lag" : 8},
            {"name" : "l9_acled_dummy_pr",      "var" : "acled_dummy_pr", "lag" : 9},
            {"name" : "l10_acled_dummy_pr",     "var" : "acled_dummy_pr", "lag" : 10},
            {"name" : "l11_acled_dummy_pr",     "var" : "acled_dummy_pr", "lag" : 11},
            {"name" : "l12_acled_dummy_pr",     "var" : "acled_dummy_pr", "lag" : 12},
...
spatial =    [
            ...
            {"name" : "q_1_1_l1_acled_dummy_pr", "var" : "l1_acled_dummy_pr", "srule" : "q", "first" : 1, "last": 1},
            {"name" : "q_1_1_l2_acled_dummy_pr", "var" : "l2_acled_dummy_pr", "srule" : "q", "first" : 1, "last": 1},
            {"name" : "q_1_1_l3_acled_dummy_pr", "var" : "l3_acled_dummy_pr", "srule" : "q", "first" : 1, "last": 1},
...
transforms = [
    ...
    {'name' : 'decay_12_cw_acled_dummy_pr_0', 'f' : 'decay', 'halflife' : 12, 'var' : 'cw_acled_dummy_pr_0'},
...
pgm_sb =   {'name' : 'pgm_sb',
               'formula' : 'ged_dummy_sb ~ decay_12_cw_acled_dummy_pr_0 + q_1_1_l1_acled_dummy_pr + q_1_1_l2_acled_dummy_pr + q_1_1_l3_acled_dummy_pr + l1_acled_dummy_pr + l2_acled_dummy_pr + l3_acled_dummy_pr + l4_acled_dummy_pr + l5_acled_dummy_pr + l6_acled_dummy_pr + l7_acled_dummy_pr + l8_acled_dummy_pr + l9_acled_dummy_pr + l10_acled_dummy_pr + l11_acled_dummy_pr + l12_acled_dummy_pr + decay_12_cw_ged_dummy_sb_0 + decay_12_cw_ged_dummy_ns_0 + decay_12_cw_ged_dummy_os_0 + l1_ged_dummy_sb + l2_ged_dummy_sb + l3_ged_dummy_sb + l4_ged_dummy_sb + l5_ged_dummy_sb + l6_ged_dummy_sb + l7_ged_dummy_sb + l8_ged_dummy_sb + l9_ged_dummy_sb + l10_ged_dummy_sb + l11_ged_dummy_sb + l12_ged_dummy_sb + q_1_1_l1_ged_dummy_sb + q_1_1_l1_ged_dummy_ns + q_1_1_l1_ged_dummy_os + q_1_1_l2_ged_dummy_sb + q_1_1_l3_ged_dummy_sb + ln_bdist3 + ln_ttime + ln_capdist + ln_pop + ln_dist_diamsec + ln_dist_petroleum + gcp_li_mer + imr_mean + mountains_mean + urban_ih_li  + excluded_dummy_li + agri_ih_li + barren_ih_li  + forest_ih_li  + savanna_ih_li  + shrub_ih_li  + pasture_ih_li',
               'modtype':'SMLogit'}

pgm_ns =   {'name' : 'pgm_ns',
               'formula' : 'ged_dummy_ns ~ decay_12_cw_acled_dummy_pr_0 + q_1_1_l1_acled_dummy_pr + q_1_1_l2_acled_dummy_pr + q_1_1_l3_acled_dummy_pr + l1_acled_dummy_pr + l2_acled_dummy_pr + l3_acled_dummy_pr + l4_acled_dummy_pr + l5_acled_dummy_pr + l6_acled_dummy_pr + l7_acled_dummy_pr + l8_acled_dummy_pr + l9_acled_dummy_pr + l10_acled_dummy_pr + l11_acled_dummy_pr + l12_acled_dummy_pr + decay_12_cw_ged_dummy_sb_0 + decay_12_cw_ged_dummy_ns_0 + decay_12_cw_ged_dummy_os_0 + l1_ged_dummy_ns + l2_ged_dummy_ns + l3_ged_dummy_ns + l4_ged_dummy_ns + l5_ged_dummy_ns + l6_ged_dummy_ns + l7_ged_dummy_ns + l8_ged_dummy_ns + l9_ged_dummy_ns + l10_ged_dummy_ns + l11_ged_dummy_ns + l12_ged_dummy_ns + q_1_1_l1_ged_dummy_sb + q_1_1_l1_ged_dummy_ns + q_1_1_l1_ged_dummy_os + q_1_1_l2_ged_dummy_ns + q_1_1_l3_ged_dummy_ns + ln_bdist3 + ln_ttime + ln_capdist + ln_pop + ln_dist_diamsec + ln_dist_petroleum + gcp_li_mer + imr_mean + mountains_mean + urban_ih_li  + excluded_dummy_li + agri_ih_li + barren_ih_li  + forest_ih_li  + savanna_ih_li  + shrub_ih_li  + pasture_ih_li',
               'modtype':'SMLogit'}

pgm_os =   {'name' : 'pgm_os',
               'formula' : 'ged_dummy_os ~ decay_12_cw_acled_dummy_pr_0 + q_1_1_l1_acled_dummy_pr + q_1_1_l2_acled_dummy_pr + q_1_1_l3_acled_dummy_pr + l1_acled_dummy_pr + l2_acled_dummy_pr + l3_acled_dummy_pr + l4_acled_dummy_pr + l5_acled_dummy_pr + l6_acled_dummy_pr + l7_acled_dummy_pr + l8_acled_dummy_pr + l9_acled_dummy_pr + l10_acled_dummy_pr + l11_acled_dummy_pr + l12_acled_dummy_pr + decay_12_cw_ged_dummy_sb_0 + decay_12_cw_ged_dummy_ns_0 + decay_12_cw_ged_dummy_os_0 + l1_ged_dummy_os + l2_ged_dummy_os + l3_ged_dummy_os + l4_ged_dummy_os + l5_ged_dummy_os + l6_ged_dummy_os + l7_ged_dummy_os + l8_ged_dummy_os + l9_ged_dummy_os + l10_ged_dummy_os + l11_ged_dummy_os + l12_ged_dummy_os + q_1_1_l1_ged_dummy_sb + q_1_1_l1_ged_dummy_ns + q_1_1_l1_ged_dummy_os + q_1_1_l2_ged_dummy_os + q_1_1_l3_ged_dummy_os + ln_bdist3 + ln_ttime + ln_capdist + ln_pop + ln_dist_diamsec + ln_dist_petroleum + gcp_li_mer + imr_mean + mountains_mean + urban_ih_li  + excluded_dummy_li + agri_ih_li + barren_ih_li  + forest_ih_li  + savanna_ih_li  + shrub_ih_li  + pasture_ih_li',
               'modtype':'SMLogit'}
