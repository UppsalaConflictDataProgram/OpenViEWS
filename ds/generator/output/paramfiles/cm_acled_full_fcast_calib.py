...
transforms = [
    ...
    {   'name' : 'decay_12_cw_acled_dummy_pr_0', 'f' : 'decay', 'halflife' : 12, 
...
cm_sb = {'name' : 'cm_sb' ,
    'formula' : "ged_dummy_sb ~ l1_ged_dummy_ns + l1_ged_dummy_os + l1_ged_dummy_sb + l1_acled_dummy_pr + l2_ged_dummy_ns + l2_ged_dummy_os + l2_ged_dummy_sb + l2_acled_dummy_pr +l3_ged_dummy_ns + l3_ged_dummy_os + l3_ged_dummy_sb + l3_acled_dummy_pr + decay_12_cw_ged_dummy_sb_0 + decay_12_cw_ged_dummy_ns_0 + decay_12_cw_ged_dummy_os_0 + decay_12_cw_acled_dummy_pr_0 + fvp_lngdpcap_nonoilrent + fvp_lngdpcap_oilrent + ln_fvp_population200 + fvp_grgdpcap_oilrent + fvp_grgdpcap_nonoilrent + ln_fvp_timeindep + ln_fvp_timesincepreindepwar + ln_fvp_timesinceregimechange + fvp_demo + fvp_semi + ssp2_edu_sec_15_24_prop + fvp_prop_excluded + ssp2_urban_share_iiasa",
    'modtype' : 'SMLogit'}

cm_ns = {'name' : 'cm_ns' ,
    'formula' : "ged_dummy_ns ~ l1_ged_dummy_ns + l1_ged_dummy_os + l1_ged_dummy_sb + l1_acled_dummy_pr + l2_ged_dummy_ns + l2_ged_dummy_os + l2_ged_dummy_sb + l2_acled_dummy_pr +l3_ged_dummy_ns + l3_ged_dummy_os + l3_ged_dummy_sb + l3_acled_dummy_pr + decay_12_cw_ged_dummy_sb_0 + decay_12_cw_ged_dummy_ns_0 + decay_12_cw_ged_dummy_os_0 + decay_12_cw_acled_dummy_pr_0 + fvp_lngdpcap_nonoilrent + fvp_lngdpcap_oilrent + ln_fvp_population200 + fvp_grgdpcap_oilrent + fvp_grgdpcap_nonoilrent + ln_fvp_timeindep + ln_fvp_timesincepreindepwar + ln_fvp_timesinceregimechange + fvp_demo + fvp_semi + ssp2_edu_sec_15_24_prop + fvp_prop_excluded + ssp2_urban_share_iiasa",
    'modtype' : 'SMLogit'}

cm_os = {'name' : 'cm_os' ,
    'formula' : "ged_dummy_os ~ l1_ged_dummy_ns + l1_ged_dummy_os + l1_ged_dummy_sb + l1_acled_dummy_pr + l2_ged_dummy_ns + l2_ged_dummy_os + l2_ged_dummy_sb + l2_acled_dummy_pr +l3_ged_dummy_ns + l3_ged_dummy_os + l3_ged_dummy_sb + l3_acled_dummy_pr + decay_12_cw_ged_dummy_sb_0 + decay_12_cw_ged_dummy_ns_0 + decay_12_cw_ged_dummy_os_0 + decay_12_cw_acled_dummy_pr_0 + fvp_lngdpcap_nonoilrent + fvp_lngdpcap_oilrent + ln_fvp_population200 + fvp_grgdpcap_oilrent + fvp_grgdpcap_nonoilrent + ln_fvp_timeindep + ln_fvp_timesincepreindepwar + ln_fvp_timesinceregimechange + fvp_demo + fvp_semi + ssp2_edu_sec_15_24_prop + fvp_prop_excluded + ssp2_urban_share_iiasa",
    'modtype' : 'SMLogit'}
