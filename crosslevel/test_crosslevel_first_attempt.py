    ...
    def setUp(self):
        ...
        * self.df_h_links: links between high and low level probs"""
        ...
        def make_links(groups_h, groups_l):
            ...
            groups_links = flatten_list(list(itertools.repeat(groups_links,
                                                              len(times))))
        ...
        t_start = 1
        t_end = 3
        n_groups_h = 100  # high resolution groups (pg_ids)
        n_groups_l = 10  # low resolution groups (country_ids)
